      ...
      <div>
        {Object.values(providers)
          ...
          .map((provider: Provider, i) => (
            <button
              className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray-200 p-[15px] font-medium text-black transition-transform duration-300 hover:scale-105 hover:bg-red-600 hover:text-white sm:w-auto sm:px-6 sm:py-3 sm:text-base md:px-8 md:py-4 md:text-base lg:px-10 lg:py-5 lg:text-base"
              key={i}
